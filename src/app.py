...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and matches focused on football skills",
        "schedule": "Mondays and Wednesdays, 3:45 PM - 5:15 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Training": {
        "description": "Drills, scrimmages, and fitness training for basketball",
    ...
    "Science Research Club": {
        "description": "Hands-on experiments and student-led research projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 17,
